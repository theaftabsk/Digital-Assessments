...
async function bootstrap() {
  ...
  const allowedOrigins = [
    'https://assessment.greatcampus.tech',
    'https://api.assessment.greatcampus.tech',
    'https://admin.assessment.greatcampus.tech',
    'https://sa.assessment.greatcampus.tech',
    'https://niva.greatcampus.tech',
    'https://admin.niva.greatcampus.tech',
    'https://sa.niva.greatcampus.tech',
    'https://api.niva.greatcampus.tech',
    'https://niva.greatcampus.in',
    'https://admin.niva.greatcampus.in',
    'https://sa.niva.greatcampus.in',
  ...
  app.enableCors({
    origin: (origin: any, callback: any) => {
      if (
        ...
        origin.includes('greatcampus.tech') ||
        origin.includes('greatcampus.in')
      ) {
        callback(null, true);
      } else {
        callback(null, true);
